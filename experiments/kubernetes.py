...
def strPodYaml(username, activeJob, scheduler, isGPU):
    ...
    strYaml = strYaml + "    - \"" + str(int(activeJob.usage.MilliCPU))+"," + str(int(activeJob.usage.NvidiaGPU))+","+ str(int(activeJob.usage.Memory/Gi)) + ","+ str(int(activeJob.priComplt))+ "\"" + "\n"
    strYaml = strYaml + "    - \"" + str(int(activeJob.secUsage.MilliCPU))+"," + str(int(activeJob.secUsage.NvidiaGPU))+","+ str(int(activeJob.secUsage.Memory/Gi)) +","+ str(int(activeJob.secComplt))+ "\"" + "\n"
    strYaml = strYaml + "    resources:" + "\n"
    strYaml = strYaml + "      requests:" + "\n"
    strYaml = strYaml + "        nvidia.com/gpu: " + str(int(activeJob.usage.NvidiaGPU)) + "\n"

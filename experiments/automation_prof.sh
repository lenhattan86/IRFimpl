...
python automation_tool.py --test False --profiling=False --measure=True --measuresec=True --interval=1 --workload=traces/profiling > automation_prof/automation_tool.log 2>&1 & 

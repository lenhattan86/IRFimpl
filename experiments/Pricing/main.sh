...
python ../get_user_info_timer.py --user user2 --interval=1 --stopTime=6000 --file=user2.csv & 
python ../get_user_info_timer.py --user user1 --interval=1 --stopTime=6000 --file=user1.csv & 
./user2.sh &
./user1.sh &
wait